...
Update-Database -Context Apply_For_Jobs_MVCIdentityContext



5. On the console execute the following command

Update-Database  -Context Apply_For_Jobs_MVCContext



6. After migration is successful Run the project 

7 if you click on Advertisements/Employers etc (Except Home) will redirect you to ASP .net identity login page login from the following credentials

User : admin@jobbank.com
Password: 1qaz2wsX@
